...
fog_dir = Rails.env == 'production' ? (ENV['S3_BUCKET_NAME'] || 'swayamvarabackend-merakee' ): 'swayamvarabackend-dev-merakee'
CarrierWave.configure do |config|
  config.fog_credentials = {:provider => 'AWS',
    :aws_access_key_id => 'dsfdfsf',#ENV['AWS_ACCESS_KEY_ID'],
    :aws_secret_access_key => 'fdfsafsda'}#ENV['AWS_SECRET_KEY']}
