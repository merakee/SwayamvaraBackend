...
# Purpose:: Api Manager for Swayamvara Backend
...
# path setup
  def base_url
    #aws_path = 'http://swayamvara-backend-master-env-hv2gxttyvi.elasticbeanstalk.com/'
    path_aws_p = 'http://swayamvara.freelogue.net/'
    path_aws_p2 = 'http://swayamvara-v2.freelogue.net/'
    path_aws_d = 'http://swayamvara-dev.freelogue.net/'
