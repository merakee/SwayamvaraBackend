#
# Client to access the Swayamvara backend server.  The Swayamvara backend will try to connect to a frontend server but leaves a port open for direct testing.
#
class SwayamvaraClient
  ...
  #
  # Perform the actual query to the remote Swayamvara backend.
  #
